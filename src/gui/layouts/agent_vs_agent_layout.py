...
from gui.components.playback_controls import PlaybackControls


class AgentVsAgentLayout(BasePokerLayout):

    def __init__(self, parent=None):
        super().__init__(parent)
        QTimer.singleShot(100, self.setup_playback_controls)
    ...
    def setup_playback_controls(self):
        ...
        for i in range(left_area_layout.count()):
            ...
            if item and item.widget() == self.control_area:
                ...
                left_area_layout.addWidget(self.playback_controls)
                break
