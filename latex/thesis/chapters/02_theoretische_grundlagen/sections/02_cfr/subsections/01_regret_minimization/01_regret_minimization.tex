...
Die Durchschnittsstrategie $\bar\sigma_i^T$ für Spieler $i$ von Zeit $1$ bis $T$ wird für jedes Informationsset $I \in \mathcal{I}_i$ und jede Aktion $a \in A(I)$ definiert als
\begin{equation}
...
Daher können regret minimierende Algorithmen im Selfplay verwendet werden, um ein approximatives Nash-Gleichgewicht zu berechnen.
