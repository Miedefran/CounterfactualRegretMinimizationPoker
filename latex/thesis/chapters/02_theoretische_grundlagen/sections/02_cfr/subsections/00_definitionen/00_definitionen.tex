...
Dieser Abschnitt führt die grundlegenden Definitionen und Konzepte ein, die für das Verständnis von Counterfactual Regret Minimization erforderlich sind.
...
Für ein Informationsset $I$ wird die Erreichbarkeitswahrscheinlichkeit definiert als:
\begin{equation}
\pi^\sigma(I) = \sum_{h \in I} \pi^\sigma(h).
\end{equation}
Analog sind $\pi_i^\sigma(I)$ und $\pi_{-i}^\sigma(I)$ als die Wahrscheinlichkeiten definiert, dass Spieler $i$ beziehungsweise die anderen Spieler das Informationsset $I$ erreichen.
...
Ein Nash-Gleichgewicht für ein Zweispieler Nullsummenspiel ist ein Strategieprofil $\sigma = (\sigma_1, \sigma_2)$, dass folgende Ungleichungen erfüllt:
\begin{equation}
...
Eine Approximation eines Nash-Gleichgewichts, auch $\varepsilon$-Nash-Gleichgewicht genannt, ist ein Strategieprofil $\sigma$, dass folgende Ungleichungen erfüllt:
\begin{equation}
