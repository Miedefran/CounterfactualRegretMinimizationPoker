...
Die extremste hier genannte Form des Samplingverfahrens ist das Outcome Sampling, bei der Zufallsereignisse, Aktionen des Gegners sowie private Aktionen zufällig ausgewählt werden.
...
Als nächstes wird im Paper eine gewichtete Form des Sampled Counterfactual Value eingeführt, um zu berücksichtigen, dass eine terminale Historie nur mit Wahrscheinlichkeit $q(z)$ in die Aktualisierung eingeht.
...
Diese Eigenschaft garantiert, dass MCCFR im Erwartungswert die gleichen Regret Updates wie CFR durchführt, obwohl nur ein Teil des Game Tree in jeder Iteration betrachtet wird.
