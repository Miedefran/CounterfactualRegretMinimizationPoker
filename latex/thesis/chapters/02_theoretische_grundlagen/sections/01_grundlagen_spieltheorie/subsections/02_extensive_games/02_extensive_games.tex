...
\begin{itemize}
  \item Eine Menge von Historien $H$.q
  Eine Historie ist eine endliche oder unendliche Sequenz von Aktionen, welche entweder von Spielern oder dem Zufall getätigt werden.\\
  ...
  \item Für jeden Spieler $i \in N$ wird die Menge der Historien $h$ mit $P(h)=i$ in Informationssets unterteilt.
  Diese Informationspartition wird bezeichnet mit$\mathcal{I}_i$.
  Ein Element $I_i \in \mathcal{I}_i$ heißt Informationsset von Spieler $i$.
  ...
  Für ein Informationsset $I_i$ bezeichnet $A(I_i)$ die verfügbaren Aktionen und $P(I_i)$ den Spieler, der am Zug ist.
...
Eine reine Strategie von Spieler $i \in N$ ordnet jedem Informationsset $I \in \mathcal{I}_i$ genau eine zulässige Aktion $s_i(I) \in A(I)$ zu.
