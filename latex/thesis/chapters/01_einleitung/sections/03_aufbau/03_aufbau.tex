...
\item \hyperref[chap:fazit]{\textbf{Kapitel 7}} fasst das Gelernte hinsichtlich der zu \hyperref[sec:zielsetzung]{Beginn} definierten Fragestellungen zusammen, diskutiert Limitationen und gibt einen Ausblick auf mögliche zukünftige Erweiterungen.

\item \hyperref[chap:anhang]{\textbf{Kapitel 8}} ist der Anhang und enthält alles, was nicht in den Hauptteil der Arbeit aufgenommen wurde.
\end{itemize}