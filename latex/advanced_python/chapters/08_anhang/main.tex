...
Das Signal-Slot-Pattern ermöglicht lose Kopplung zwischen Komponenten.
Die \texttt{ActionButtons}-Klasse definiert ein Signal, das emittiert wird, wenn ein Spieler eine Aktion wählt:
